...
z-index:100;
 ...
 <div class="site-section"  data-aos="fade" id="portfolio">
        ...
        <form action="<?= base_url('frontend/gallery'); ?>" method="post" >
    ...
    <div class = col-md-4>
                ...
                <?php foreach ($hasil as $datas) :?>
                  <div class="col-lg-4 col-sm-6 mb-4">
                     <div class="portfolio-item">
                     <a class="portfolio-link"  href="<?= base_url();?>gallery/morephotos/<?=$datas['kodeclient'];?> "
                                ><div class="portfolio-hover">
                               <div class="portfolio-hover-content"><i class="fas fa-eye fa-3x"></i></div>
                           </div>
                            <img  style="width:400px;height:300px" class="img-fluid" src="<?= base_url();?>gambar/<?=$datas['foto'];?> " alt=""/></a>
                          <div class="portfolio-caption">
                             <div class="portfolio-caption-heading"><?= $datas['namaclient']; ?></div>
                             <div class="portfolio-caption-subheading text-muted"><?= $datas['jenis']; ?></div>
                         </div>
                     </div>
                </div>
                  <?php endforeach; ?>
