  ...
  <div class="container-fluid" data-aos="fade" data-aos-delay="500">
    <div class="swiper-container images-carousel">
		...
		if ($hasil){
         ...
         echo'         <h2 class="mb-3">'.$row->namaclient.'</h2>';
         echo'        <a href="'.base_url().'gallery/morephotos/'.$row->kodeclient.'" class="btn btn-outline-white py-2 px-4">More Photos</a>';
         echo'       </div>';
         echo'       <img src="'.base_url().'gambar/'.$row->foto.'" alt="Image">';
         echo'     </div>';
         echo'   </div>';
        }
    }
